...
import org.ledon.springai.rag.ELT.ChineseTokenTextSplitter;
...
public class RerankTest {
    ...
    public void testRerank(
        ...
        RetrievalRerankAdvisor retrievalRerankAdvisor = new RetrievalRerankAdvisor(vectorStore,
                dashScopeRerankModel, SearchRequest.builder().topK(200).build());
...
//            @Autowired VectorStore vectorStore,
//           @Autowired DashScopeRerankModel dashScopeRerankModel,
//           @Autowired OllamaChatModel dashScopeChatModel
//    ) {
//
