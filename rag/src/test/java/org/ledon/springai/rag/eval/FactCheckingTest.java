package org.ledon.springai.rag.eval;
...
//        var factCheckingEvaluator = new FactCheckingEvaluator(ChatClient.builder(chatModel));
        var factCheckingEvaluator = FactCheckingEvaluator.builder(ChatClient.builder(chatModel))
                .build();
        // 发送给大模型上下文和声明
     ...
     */
    @Test
    void testRelevancyEvaluator(@Autowired OllamaChatModel chatModel) {
