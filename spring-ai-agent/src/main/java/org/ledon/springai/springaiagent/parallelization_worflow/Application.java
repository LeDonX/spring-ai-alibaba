...
*/
package org.ledon.springai.springaiagent.parallelization_worflow;

import org.ledon.springai.springaiagent.config.RestClientConfig;
...
public class Application {
	...
	@Bean
	public CommandLineRunner commandLineRunner(OllamaChatModel dashScopeChatModel) {
