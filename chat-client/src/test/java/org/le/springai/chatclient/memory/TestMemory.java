...
public class TestMemory {
    ...
    @Test
    public void testMemory(@Autowired OllamaChatModel chatModel) {
        ChatClient chatClient = ChatClient
                .builder(chatModel)
                .build();

        String chatHis = "我叫LeDon";
    ...
    public void testMemory2(@Autowired
        ...
        String conversationId = "le001";   // 当前对话唯一标识

        // First interaction
        UserMessage userMessage1 = new UserMessage("我叫LeDon");
